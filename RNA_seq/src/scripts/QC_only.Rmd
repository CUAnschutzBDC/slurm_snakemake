...
params:
  ...
  DE_alpha: 0.05
  DE_lfc: 1
  counts: "results/human_cytokine_countTable_cutadapt_trim.txt"
...
# Cassatt 1
treatment_colors <- met.brewer(name="Cassatt1",
...
group_colors <- met.brewer(name = "Egypt", 
...
# Derain for batch 1
genotype_colors <- met.brewer(name = "Derain",
