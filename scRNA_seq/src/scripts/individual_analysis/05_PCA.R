...
if (VDJ_B){
  ...
  VariableFeatures(seurat_data) <- 
    VariableFeatures(seurat_data)[!grepl("IG[H|L|K]",
                                         VariableFeatures(seurat_data))]  
}
if (VDJ_T){
  # Remove T cell chains
  VariableFeatures(seurat_data) <- 
    VariableFeatures(seurat_data)[!grepl("TR[A|B][V|J|C]",
                                         VariableFeatures(seurat_data))]  
}
